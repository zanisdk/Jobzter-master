...
/// 
//Brug af skolen SMTP
//Mail mf = new Mail("vid233.vid.net.local", "hto@videndjurs.dk", "Henrik Obsen");

//Brug din egen gmail og Googles SMTP
//Mail mf = new Mail("smtp.gmail.com", "email@gmail.com", "DitNavne", "password", 587);
...
public class Mail
{
	...
	public Mail(string SMTP, string fromEmail, string fromName)
	{
        _SMTP = SMTP;
    ...
    public Mail(string SMTP, string fromEmail, string fromName, string password, int port)
    {
        _SMTP = SMTP;
        _fromEmail = fromEmail;
        _fromName = fromName;
